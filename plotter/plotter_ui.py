...
def printHide(print_file,id):
	print_file.write('$(function(){\n')
	print_file.write('$("#'+id+'").hide()\n')
	print_file.write('});\n')

if(percentage != -1):
	printDoughChart(stats_file,percentage,"perChart")
else:
	printHide(stats_file,"perChart")
if(percentage_senti != -1):
	printDoughChart(stats_file,percentage_senti,"sentiPerChart")
else:
	printHide(stats_file,"sentiPerChart")
